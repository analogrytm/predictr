...
/**
  `Ember.HaveFunHubLocation` implements the location API using the browser's
  `history.pushState` API.

  @class HaveFunHubLocation
  @namespace HaveFunHub
  @extends Ember.Object
*/
Ember.HaveFunHubLocation = Ember.Object.extend({
  init: function() {
...
Ember.Location.registerImplementation('havefunhub_location', Ember.HaveFunHubLocation);
